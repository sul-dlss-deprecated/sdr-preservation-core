...
@obj = ActiveFedora::Base.find(pid=@druid)
or
@obj = ActiveFedora::DigitalObject.find(ActiveFedora::Base, pid=@druid)


# Add a datastream
@ds = ActiveFedora::Datastream.new(@obj, dsid='sdrIngestWF', :dsLabel=>'sdrIngestWF', :content=>wf_str)
@ds.save
